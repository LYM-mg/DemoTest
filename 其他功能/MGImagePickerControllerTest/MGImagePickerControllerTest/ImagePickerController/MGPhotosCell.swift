...
class MGPhotosCell: UICollectionViewCell {
    ...
    lazy var mg_chooseControl: UIControl = {
        ...
        chooseControl.action(at: .touchUpInside, handle: { [weak self](_) in
...
// MARK: private
    ...
    fileprivate func addAndLayoutSubViews() {
        ...
        mg_chooseControl.translatesAutoresizingMaskIntoConstraints = false
        mg_chooseControl.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: 3).isActive = true
        mg_chooseControl.rightAnchor.constraint(equalTo: self.rightAnchor, constant: 3).isActive = true
        mg_chooseControl.widthAnchor.constraint(equalToConstant: 45).isActive = true
        mg_chooseControl.heightAnchor.constraint(equalToConstant: 45).isActive = true
        
        mg_chooseImageView.translatesAutoresizingMaskIntoConstraints = false
        mg_chooseImageView.bottomAnchor.constraint(equalTo: self.bottomAnchor).isActive = true
        mg_chooseImageView.rightAnchor.constraint(equalTo: self.rightAnchor).isActive = true
        mg_chooseImageView.widthAnchor.constraint(equalToConstant: 25).isActive = true
        mg_chooseImageView.heightAnchor.constraint(equalToConstant: 25).isActive = true
        
        mg_messageView.translatesAutoresizingMaskIntoConstraints = false
        mg_messageView.bottomAnchor.constraint(equalTo: self.bottomAnchor).isActive = true
        mg_messageView.rightAnchor.constraint(equalTo: self.rightAnchor).isActive = true
        mg_messageView.leftAnchor.constraint(equalTo: self.leftAnchor).isActive = true
        mg_messageView.heightAnchor.constraint(equalToConstant: 20).isActive = true
        
        mg_messageLabel.translatesAutoresizingMaskIntoConstraints = false
        mg_messageLabel.bottomAnchor.constraint(equalTo: mg_messageView.bottomAnchor).isActive = true
        mg_messageLabel.rightAnchor.constraint(equalTo: mg_messageView.rightAnchor).isActive = true
        mg_messageLabel.leftAnchor.constraint(equalTo: mg_messageView.leftAnchor).isActive = true
        mg_messageLabel.heightAnchor.constraint(equalToConstant: 20).isActive = true
