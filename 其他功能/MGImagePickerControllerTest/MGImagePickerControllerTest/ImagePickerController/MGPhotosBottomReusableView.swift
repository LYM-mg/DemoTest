...
//            self.mg_assetLabel.text = "共有\(newValue)张照片"
    ...
    fileprivate func setUpUI() {
        ...
        mg_assetLabel.translatesAutoresizingMaskIntoConstraints = false
        mg_assetLabel.topAnchor.constraint(equalTo: self.topAnchor).isActive = true
        mg_assetLabel.leadingAnchor.constraint(equalTo: self.leadingAnchor).isActive = true
        mg_assetLabel.bottomAnchor.constraint(equalTo: self.bottomAnchor).isActive = true
        mg_assetLabel.trailingAnchor.constraint(equalTo: self.trailingAnchor).isActive = true
